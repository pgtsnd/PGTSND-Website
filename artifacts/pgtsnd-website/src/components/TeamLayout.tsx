      ...
      >
        ...
        <div style={{ padding: "0 20px", marginBottom: "24px" }}>
          <div style={{ padding: "8px 12px", background: t.hoverBg, borderRadius: "6px", display: "flex", alignItems: "center", gap: "8px" }}>
            ...
            <span style={{ fontFamily: "'Montserrat', sans-serif", fontWeight: 600, fontSize: "10px", textTransform: "uppercase", letterSpacing: "0.08em", color: t.textTertiary }}>Team Portal</span>
          </div>
        </div>
