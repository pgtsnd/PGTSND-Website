    ...
    <ClientLayout>
      <div style={{ display: "flex", height: "calc(100vh)" }}>
            ...
            {conversations.map((convo) => (
              <div
                ...
                style={{
                  padding: "16px 20px",
                  cursor: "pointer",
                  background: activeConvo.id === convo.id ? "rgba(255,255,255,0.04)" : "transparent",
                  borderLeft: activeConvo.id === convo.id ? "2px solid #ffffff" : "2px solid transparent",
                  transition: "all 0.1s ease",
                }}
              >
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "6px" }}>
                  <p style={{ fontFamily: "'Montserrat', sans-serif", fontWeight: 600, fontSize: "14px", color: "#ffffff" }}>
                    {convo.name}
                  </p>
        ...
        <div style={{ flex: 1, display: "flex", flexDirection: "column" }}>
          ...
          >
            <div>
              <h3 style={{ fontFamily: "'Montserrat', sans-serif", fontWeight: 700, fontSize: "16px", color: "#ffffff", marginBottom: "4px" }}>
                {activeConvo.name}
              </h3>
              <p style={{ fontFamily: "'Montserrat', sans-serif", fontWeight: 400, fontSize: "12px", color: "rgba(255,255,255,0.4)" }}>
                {activeConvo.participants.join(", ")}
              </p>
            </div>
            ...
            {activeConvo.messages.map((msg, i) => (
              <div
                ...
                style={{
                  ...
                  gap: "12px",
                  marginBottom: "24px",
                  flexDirection: msg.isTeam ? "row" : "row-reverse",
                }}
              >
                <div
                  style={{
                    ...
                    height: "36px",
                    borderRadius: "50%",
                    background: msg.isTeam ? "rgba(255,255,255,0.08)" : "rgba(255,255,255,0.15)",
                    display: "flex",
                    alignItems: "center",
                    justifyContent: "center",
                    fontFamily: "'Montserrat', sans-serif",
                ...
                <div style={{ maxWidth: "65%" }}>
                  ...
                  >
                    ...
                    <span
                      style={{
                        ...
                        color: msg.isTeam ? "rgba(120,180,255,0.7)" : "rgba(255,255,255,0.35)",
                        background: msg.isTeam ? "rgba(120,180,255,0.08)" : "rgba(255,255,255,0.04)",
                        padding: "2px 8px",
                        borderRadius: "4px",
                      }}
                    >
                  ...
                  <div
                    style={{
                      ...
                      lineHeight: 1.65,
                      background: msg.isTeam ? "rgba(255,255,255,0.03)" : "rgba(255,255,255,0.06)",
                      padding: "14px 18px",
                      borderRadius: msg.isTeam ? "2px 12px 12px 12px" : "12px 2px 12px 12px",
                    }}
                  >
                    {msg.text}
                  </div>
