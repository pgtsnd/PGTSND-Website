...
function pickHeaderImage(project: { id: string; name: string }): string {
              ...
              <Link key={project.id} href={`/team/projects/${project.id}`} style={{ textDecoration: "none" }}>
                <div style={{
                  ...
                  <div style={{
                    ...
                    padding: "12px 16px",
                    filter: project.status === "archived" ? "grayscale(1)" : undefined,
                  }}>
                    <div style={{
                    ...
                    <div style={{
                      ...
                      height: "100%", background: "linear-gradient(180deg, rgba(0,0,0,0.15) 0%, rgba(0,0,0,0.55) 70%, rgba(0,0,0,0.85) 100%)",
                    }} />
