          ...
          <div ref={heroRef} style={{ position: "relative", overflow: "visible" }}>
            <div style={{ width: "100%", height: "clamp(340px, 40vw, 520px)", overflow: "hidden" }}>
              <img
                ...
                style={{ width: "140%", height: "100%", objectFit: "cover", objectPosition: "center 30%", display: "block", marginLeft: "-35%", transform: `translateX(${heroOffset - 5}%)`, willChange: "transform" }}
              />
            </div>
