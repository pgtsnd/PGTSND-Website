  ...
  return (
    <>
      ...
      <div style={{ background: "#000000", minHeight: "100vh" }}>
        ...
        {/* Bottom CTA */}
        <section style={{ padding: "100px 80px 40px", display: "grid", gridTemplateColumns: "1fr 1fr", gap: "80px", alignItems: "center" }}>
...
function ProductTubsSlideIn() {
  ...
  return (
    <div ref={ref} style={{ width: "100%", position: "relative" }}>
      ...
      />
      <div style={{ position: "absolute", bottom: "-105px", right: "20px" }}>
        <ScrollBadge position="bottom-right" inline />
      </div>
    </div>
  );
